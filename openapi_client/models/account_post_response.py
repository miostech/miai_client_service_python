...
class AccountPostResponse(BaseModel):
    ...
    AccountPostResponse
    """ # noqa: E501
    msg: StrictStr = Field(description="Message of response")
    data: Optional[Any]
    token: Optional[Any] = Field(description="Access token")
    __properties: ClassVar[List[str]] = ["msg", "data", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "msg": obj.get("msg"),
            "data": obj.get("data"),
            "token": AnyOf.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
