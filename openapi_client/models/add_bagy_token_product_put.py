...
class AddBagyTokenProductPut(BaseModel):
    """
    AddBagyTokenProductPut
    """ # noqa: E501
    id_product: StrictStr = Field(description="Id of product")
    bagy_token: StrictStr = Field(description="Bagy token of product")
    __properties: ClassVar[List[str]] = ["id_product", "bagy_token"]
