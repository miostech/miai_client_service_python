...
class AddTokenMetaProductPut(BaseModel):
    """
    AddTokenMetaProductPut
    """ # noqa: E501
    id_product: StrictStr = Field(description="Id of product")
    token_meta: StrictStr = Field(description="Token meta of product")
    wa_business_id: StrictStr = Field(description="Id of business id")
    __properties: ClassVar[List[str]] = ["id_product", "token_meta", "wa_business_id"]
