...
class WhatsappMessageClickedPost(BaseModel):
    """
    WhatsappMessageClickedPost
    """ # noqa: E501
    template_name: StrictStr = Field(description="Name of template")
    __properties: ClassVar[List[str]] = ["template_name"]
